...
public class PatientCreateRequestDto {
    ...
    @Schema(description = "Patient family name (last name)", example = "Smith", required = true)
    @NotBlank(message = "Family name is required")
    @Size(max = 100, message = "Family name must not exceed 100 characters")
    private String familyName;

    @Schema(description = "Patient given name (first name)", example = "John", required = true)
    ...
    public PatientCreateRequestDto(String familyName, String givenName) {
