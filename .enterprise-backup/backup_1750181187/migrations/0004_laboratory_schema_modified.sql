...
-- Insert default test categories first
INSERT INTO lab_test_categories (id, name, description) VALUES
(1, 'Hematology', 'Blood cell studies and related tests'),
(2, 'Biochemistry', 'Chemical analysis of body fluids'),
(3, 'Microbiology', 'Study of microorganisms'),
(4, 'Serology', 'Study of serum for antibody detection'),
(5, 'Pathology', 'Study of disease processes'),
(6, 'Immunology', 'Study of immune system'),
(7, 'Molecular Diagnostics', 'DNA/RNA based tests');

-- Drop existing lab_tests table if it exists (from initial schema)
...
-- Create some sample lab tests
INSERT INTO lab_tests (category_id, code, name, description, sample_type, processing_time, price, is_active) VALUES
(1, 'CBC', 'Complete Blood Count', 'Basic blood test that measures different cells in the blood', 'Blood', 60, 500, true),
(1, 'HB', 'Hemoglobin', 'Measures the amount of hemoglobin in the blood', 'Blood', 30, 200, true),
(2, 'GLU', 'Blood Glucose', 'Measures the amount of glucose in the blood', 'Blood', 45, 250, true),
(2, 'LFT', 'Liver Function Test', 'Panel of tests to check liver function', 'Blood', 120, 800, true);
...
CREATE INDEX idx_lab_report_delivery_report ON lab_report_delivery(report_id);
