  ...
  try {
    ...
    */
    ...
    const results = [
      {
        id: "log_uuid_1",
         new Date(crypto.getRandomValues(new Uint32Array(1))[0] - 60 * 60 * 1000).toISOString(), // 1 hour ago
        status: "Triage",
         "clerk_789",
      ...
      {
        id: "log_uuid_2",
         new Date(crypto.getRandomValues(new Uint32Array(1))[0] - 45 * 60 * 1000).toISOString(), // 45 mins ago
        status: "Assessment",
         "nurse_456",
      ...
      {
        id: "log_uuid_3",
         new Date(crypto.getRandomValues(new Uint32Array(1))[0] - 15 * 60 * 1000).toISOString(), // 15 mins ago
        status: "Treatment",
         "nurse_456",
