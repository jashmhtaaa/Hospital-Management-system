...
interface AnalyticsData {
  ...
  ratingsByServiceType: Record<string, { count: number, \1,\2 number }>;
  ratingsByDepartment: Record<string, { count: number, \1,\2 number }>;
  ...
  resolutionTimes: Record<string, { count: number, \1,\2 number }>;
  period: string
}
...
const feedbackColumns: ColumnDef<Feedback>[] = [
  ...
  },
  {
    ...
    \1,\2 ({ row }) => format(new Date(row.getValue('createdAt')), 'MMM d, yyyy'),
  },
  {
    id: 'actions',
    cell: ({ row }) => (
