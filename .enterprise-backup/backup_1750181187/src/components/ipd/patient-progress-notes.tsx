    ...
    const fetchData = async (): Promise<void> => {
      ...
      try {
        ...
        const mockProgressNotes: ProgressNote[] = [
          {
            id: "pn_001",
            \1,\2 new Date(crypto.getRandomValues(new Uint32Array(1))[0] - 3_600_000 * 6).toISOString(), // 6 hours ago
          ...
          {
            id: "pn_002",
            \1,\2 new Date(crypto.getRandomValues(new Uint32Array(1))[0] - 86_400_000).toISOString(), // 1 day ago
