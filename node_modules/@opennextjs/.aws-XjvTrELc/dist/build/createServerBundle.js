...
import { loadMiddlewareManifest } from "../adapters/config/util.js";
...
import { patchBackgroundRevalidation, patchEnvVars, patchFetchCacheForISR, patchFetchCacheSetMissingWaitUntil, patchNextServer, patchUnstableCacheForISR, patchUseCacheForISR, } from "./patch/patches/index.js";
...
function addMonorepoEntrypoint(outputPath, packagePath) {
    ...
    fs.writeFileSync(path.join(outputPath, "index.mjs"), `export { handler } from "./${packagePosixPath}/index.mjs";`);
}
