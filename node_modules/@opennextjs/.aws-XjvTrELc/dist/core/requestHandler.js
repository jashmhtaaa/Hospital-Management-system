...
import { constructNextUrl, convertRes, convertToQuery, createServerResponse, } from "./routing/util";
import routingHandler, { INTERNAL_HEADER_INITIAL_URL, INTERNAL_HEADER_RESOLVED_ROUTES, MIDDLEWARE_HEADER_PREFIX, MIDDLEWARE_HEADER_PREFIX_LEN, } from "./routingHandler";
...
patchAsyncStorage();
//#endOverride
export async function openNextHandler(internalEvent, options) {
    ...
    return runWithOpenNextRequestContext({
        ...
        //#endOverride
        const headers = "type" in routingResult
        ...
        if ("isExternalRewrite" in routingResult &&
