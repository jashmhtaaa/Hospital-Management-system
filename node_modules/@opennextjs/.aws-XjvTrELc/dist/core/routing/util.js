...
import { BuildId, HtmlPages, NextConfig } from "../../adapters/config/index.js";
 ...
 * @__PURE__
 */
export function isExternal(url, host) {
    if (!url)
        return false;
    const pattern = /^https?:\/\//;
    if (host) {
...
export function convertFromQueryString(query) {
    if (query === "")
        return {};
 ...
 * @__PURE__
 */
export function getUrlParts(url, isExternal) {
    if (!isExternal) {
        const regex = /\/([^?]*)\??(.*)/;
 ...
 * @__PURE__
 */
export function constructNextUrl(baseUrl, path) {
 ...
 * @__PURE__
 */
export function convertRes(res) {
 ...
 * @__PURE__
 */
export function convertToQuery(querystring) {
 ...
 * @__PURE__
 */
export function getMiddlewareMatch(middlewareManifest, functionsManifest) {
 ...
 * @__PURE__
 */
export function escapeRegex(str, { isPath } = {}) {
    const result = str
        .replaceAll("(.)", "_µ1_")
        .replaceAll("(..)", "_µ2_")
        .replaceAll("(...)", "_µ3_");
 ...
 * @__PURE__
 */
export function convertBodyToReadableStream(method, body) {
...
(function (CommonHeaders) {
    CommonHeaders["CACHE_CONTROL"] = "cache-control";
    CommonHeaders["NEXT_CACHE"] = "x-nextjs-cache";
})(CommonHeaders || (CommonHeaders = {}));
/**
 *
 * @__PURE__
 */
export function fixCacheHeaderForHtmlPages(internalEvent, headers) {
 ...
 * @__PURE__
 */
export function fixSWRCacheHeader(headers) {
 ...
 * @__PURE__
 */
export function addOpenNextHeader(headers) {
 ...
 * @__PURE__
 */
export async function revalidateIfRequired(host, rawPath, headers, req) {
 ...
 * @__PURE__
 */
export function fixISRHeaders(headers) {
 ...
 * @__PURE__
 */
export function createServerResponse(routingResult, headers, responseStream) {
