import { BuildId, ConfigHeaders, NextConfig, PrerenderManifest, RoutesManifest, } from "../adapters/config/index";
import { debug, error } from "../adapters/logger";
import { cacheInterceptor } from "./routing/cacheInterceptor";
import { detectLocale } from "./routing/i18n";
import { fixDataPage, getNextConfigHeaders, handleFallbackFalse, handleRedirects, handleRewrites, } from "./routing/matcher";
import { handleMiddleware } from "./routing/middleware";
import { apiPrefix, dynamicRouteMatcher, staticRouteMatcher, } from "./routing/routeMatcher";
...
export default async function routingHandler(event) {
    try {
        ...
        const isApiRoute = internalEvent.rawPath === apiPrefix ||
        ...
        if (!(isRouteFoundBeforeAllRewrites ||
            isApiRoute ||
            isNextImageRoute ||
        ...
        if (globalThis.openNextConfig.dangerous?.enableCacheInterception &&
