...
exports.PulseSubscriptionFilterSerializer = void 0;
...
// still don't have isDecimalJsLike here 😭
...
const isDecimal = (value) => {
    return (index_browser_js_1.Decimal.isDecimal(value) ||
        (value != null &&
            typeof value === "object" &&
            "d" in value &&
    ...
    #serializeValue(type, value) {
        ...
        switch (true) {
            ...
            case type === "Decimal" &&
                ...
                return { $type: type, value: new index_browser_js_1.Decimal(value).toFixed() }; // be helpful, coerce to decimal
...
exports.PulseSubscriptionFilterSerializer = PulseSubscriptionFilterSerializer;
