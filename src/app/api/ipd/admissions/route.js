...
require("next/server");
from;
"@/lib/ipd"; // Assuming these functions exist and handle DB interaction;
...
try { }
    ...
    return NextResponse.json();
    {
        error: "Failed to fetch admissions", details;
        errorMessage;
    }
    {
        status: 500;
...
try { }
    ...
    if (!session.user) {
        return NextResponse.json();
        {
            error: "Missing required fields (e.g., patient_id)";
        }
        {
            status: 400;
        }
    ...
    try { }
        ...
        return NextResponse.json();
        {
            error: "Failed to create admission", details;
            errorMessage;
        }
        {
            status: 500;
...
try { }
         ...
         | id <= 0;
    {
        ...
        try { }
            ...
            return NextResponse.json();
            {
                error: "Failed to update admission", details;
                errorMessage;
            }
            {
                status: 500;
