...
() => Promise.resolve([]),
    findOverdue;
(overdueThreshold) => Promise.resolve([]),
    save;
...
// Audit logging;
await (0, database_1.auditLog)("MEDICATION_ADMINISTRATION", { action: "LIST_OVERDUE",
    userId,
    details: {
        overdueThreshold,
        locationId,
...
// Return response;
return server_1.NextResponse.json({ overdueAdministrations: paginatedAdministrations,
    severityCounts,
    overdueThreshold,
    pagination: {
        page,
...
try { }
    ...
    return (0, database_2.errorHandler)(error, "Error retrieving overdue medications");
}
/**;
