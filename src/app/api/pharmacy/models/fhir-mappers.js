...
const domain_models_ts_1 = require("./domain-models.ts");
;
Array > ;
text: string;
;
...
dosage ?  : {
    ...
    note: Array > ,
    const: _medicationToFHIR = (medication) => {
            ...
            []:  };
        {
             ...
             */ ;
            export const _fhirToMedication = (fhirMedication) => {
                ...
                order: domain_models_ts_1.MedicationOrder,
                    string,
                    medicationName;
                string;
            };
            FHIRMedicationRequest;
            {
                ...
                return { resourceType: "MedicationRequest",
                    "1": ,
                    lastUpdated: timestamp, new: Date().toISOString(),
                    status: order.status, } `Medication/${order.medicationId}`,
                    display;
                medicationName,
                ...
                order.orderDate.toISOString(),
                    ...
                    display;
                providerName,
                    dosageInfo.instructions || "",
                    dosageInfo.frequency || 1,
                    dosageInfo.periodUnit || "d",
                    [
                ...
                order.endDate?.toISOString() || ;
                new Date(order.orderDate.getTime() + 30 * 24 * 60 * 60 * 1000).toISOString(),
                    numberOfRepeatsAllowed;
                dosageInfo.refills || 0,
                    dosageInfo.quantity || 1,
                    "https://unitsofmeasure.org",
                    code;
                dosageInfo.unit || "",
                ...
                "https://unitsofmeasure.org",
                    code;
                "d",
                    dosageInfo.allowSubstitution || true;
                /**;
                 ...
                 */ ;
                export const _fhirToMedicationOrder = (fhirRequest) => {
...
export const _medicationDispenseToFHIR = (;
  ...
  return {resourceType:"MedicationDispense",
    ...
    `;
                                                            domain_models_ts_1.Medication / $dispense.medicationId `,
    ...
    authorizingPrescription: [;
      {reference:`;
                                                            MedicationRequest / $dispense.prescriptionId `;
...
export const _medicationAdministrationToFHIR = (;
  ...
  return {resourceType:"MedicationAdministration",
    ...
    `;
                                                            domain_models_ts_1.Medication / $administration.medicationId `,
      display: medicationName;
    },
    `;
    ...
    ` /* administration.site ? {coding:[;
                                                         ...
                                                         */;
                                                            export const _fhirToMedicationAdministration = (fhirAdministration) => {
                                                                // Extract IDs from references;
                                                                ...
                                                                return { id: fhirAdministration.id,
                                                                    patientId,
                                                                    providerId,
                                                                    medicationId,
                                                                    prescriptionId,
