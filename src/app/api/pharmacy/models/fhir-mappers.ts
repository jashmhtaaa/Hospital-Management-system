 ...
 */
export const medicationToFHIR = (medication: Medication): FHIRMedication {
  return {
    resourceType: 'Medication',
    id: medication.id,
    meta: {
 ...
 */
export const medicationOrderToFHIR = (
 ...
 */
export const medicationDispenseToFHIR = (
 ...
 */
export const medicationAdministrationToFHIR = (
