 ...
 */ ;
isWithinAdministrationWindow(prescription, PharmacyDomain.Prescription);
boolean;
{
...
Date[];
{
     ...
     */ ;
    async;
    shouldCompletePrescription(prescription, PharmacyDomain.Prescription);
    Promise < boolean > {
    ...
    };
    {
         ...
         * @returns Patient ID;
         */ ;
        decodePatientBarcode(barcode, string);
        string;
        {
             ...
             */ ;
            decodeMedicationBarcode(string);
            batchNumber ?  : string;
            expirationDate ?  : Date;
        }
        {
