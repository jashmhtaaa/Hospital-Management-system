...
import {  getDB  } from "next/server" from "@/lib/database"; // Import getDB;
...
interface CreatedRadiologyReportQueryResultRow {id:number | string; // Assuming ID can be number or string;
