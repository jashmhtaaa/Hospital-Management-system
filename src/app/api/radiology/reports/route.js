...
bind(...parameters);
all();
return server_1.NextResponse.json(result.results || []);
try { }
catch (error) {
    const message = ;
    ...
    {
        error: "Failed to fetch radiology reports", details;
        message;
    }
    {
        status: 500;
        ...
        if (!session.user) {
            ...
            if (!session.user) {
                ...
                try { }
                    ...
                    return server_1.NextResponse.json();
                    {
                        error: "Failed to create radiology report", details;
                        message;
                    }
                    {
                        status: 500;
