...
describe("Notifications Module", () => {
    ...
    beforeEach(() => {
        // Reset mocks;
        module_2.jest.clearAllMocks();
        // Setup mock implementation;
        mockQuery = module_2.jest.fn();
        mockClose = module_2.jest.fn();
        module_1.DB.mockReturnValue({ query: mockQuery,
            close: mockClose });
    });
    describe("notifyUsers", () => {
        it("should create notifications for multiple users", async () => {
            // Setup;
            const userIds = [1, 2, 3];
            const notification = { type: "result_available",
            ...
            mockQuery.mockImplementation(() => ({ insertId: 42,
                ...
                results: [] }));
            // Execute;
            const result = await (0, module_2.notifyUsers)(userIds, notification);
            // Verify;
