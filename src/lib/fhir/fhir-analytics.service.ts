 ...
 */;
      ...
      return analytics} catch (error) { console.error(error); }
  }
  ...
  console.error(error);
      ...
      return metrics} catch (error) { console.error(error); }
  ...
  console.error(error);
      ...
      return trends} catch (error) { console.error(error); }
...
} catch (error) { console.error(error); }:${metrics.join("-")}:${timeframe,}`,
      const cached = await cacheService.getCachedResult("fhir_analytics:", cacheKey),
      if (!session.user)eturn cached,
