...
import { FHIRAppointment, FHIRAppointmentUtils } from './appointment.ts';
import { FHIREncounter, FHIREncounterUtils } from './encounter.ts';
import { FHIRMedicationRequest, FHIRMedicationUtils } from './medication.ts';
import { FHIRPatient, FHIRPatientUtils } from './patient.ts';
