 ...
 */;
  ...
  static async upsertPatient(hmsPatientData: unknown): Promise<{hmsPatient: unknown,
   ...
   */;
  static async getPatient(patientId: string): Promise<{hmsPatient: unknown,
  ...
  static async searchPatients(unknown[],
    ...
    if (!session.user) {
      return {hmsPatients: [], fhirBundle: null,
    }
 ...
 */;
  ...
  static async createAppointment(hmsAppointmentData: unknown): Promise<{hmsAppointment: unknown,
  ...
  static async updateAppointmentStatus();
    ...
    newStatus: string,
  ): Promise<{hmsAppointment: unknown,
