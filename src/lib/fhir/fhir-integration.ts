...
import { FHIRPatient, FHIRPatientUtils } from './patient';
import { FHIRAppointment, FHIRAppointmentUtils } from './appointment';
import { FHIREncounter, FHIREncounterUtils } from './encounter';
import { FHIRMedicationRequest, FHIRMedicationUtils } from './medication';
...
export class FHIRPatientIntegration {
   ...
   */
  static async upsertPatient(hmsPatientData: any): Promise<{ hmsPatient: any; fhirPatient: FHIRPatient }> {
   ...
   */
  static async getPatient(patientId: string): Promise<{ hmsPatient: any; fhirPatient: FHIRPatient } | null> {
   ...
   */
  static async searchPatients(searchParams: any): Promise<{
    hmsPatients: any[];
    fhirBundle: any;
    total: number;
  }> {
  ...
  private static convertFHIRToHMS(fhirPatient: FHIRPatient): any {
...
export class FHIRAppointmentIntegration {
   ...
   */
  static async createAppointment(hmsAppointmentData: any): Promise<{ hmsAppointment: any; fhirAppointment: FHIRAppointment }> {
  ...
  static async updateAppointmentStatus(
    ...
    newStatus: string,
    notes?: string
  ): Promise<{ hmsAppointment: any; fhirAppointment: FHIRAppointment }> {
