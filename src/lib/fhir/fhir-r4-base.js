...
exports.FHIRResourceManager = void 0;
/**;
    ...
    constructor(resourceType) {
        ...
        string;
        {
            ...
            FHIRMeta;
            {
                ...
                // Create narrative;
                createNarrative(content, string, status, FHIRNarrative["status"] = "generated");
                FHIRNarrative;
                {
                    return {
                        status,
                        ...
                        // Create coding;
                        createCoding(system, code, display) {
                            return {
                                system,
                                code,
                                display
                            ...
                            createCodeableConcept(codings, FHIRCoding[], text ?  : string);
                            FHIRCodeableConcept;
                            {
                                return { coding: codings,
                                    text };
                                // Create identifier;
                                createIdentifier(system, string, value, string, use ?  : FHIRIdentifier["use"]);
                                FHIRIdentifier;
                                {
                                    return { use: use || "usual",
                                        ...
                                        value };
                                    // Create reference;
                                    createReference(resourceType, string, id, string, display ?  : string);
                                    FHIRReference;
                                    {
                                        ...
                                        abstract;
                                        toFHIR(internalData, unknown);
                                        T;
                                        abstract;
                                        fromFHIR(fhirResource, T);
                                        unknown;
...
exports.FHIRResourceManager = FHIRResourceManager;
