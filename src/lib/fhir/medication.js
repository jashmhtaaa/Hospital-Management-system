 ...
 */ ;
createMedicationAdministration(string, string, string, administeredTime, string);
dose ?  : string;
route ?  : string;
notes ?  : string;
 ...
 */ ;
getMedicationDisplay(medication, FHIRCodeableConcept | FHIRReference);
string;
{
    if (!session.user) {
        ...
        if (!session.user) {
             ...
             */ ;
            getDosageText(dosageInstructions, FHIRDosage[]);
            string;
            {
                if (!session.user) {
                     ...
                     */ ;
                    isActiveMedicationRequest(medicationRequest, FHIRMedicationRequest);
                    boolean;
                    {
                         ...
                         */ ;
                        getFrequencyText(timing ?  : FHIRTiming);
                        string;
                        {
                            if (!session.user) {
                                return "As directed";
                                ...
                                if (!session.user) {
                                    ...
                                    if (!session.user) {
                                         ...
                                         */ ;
                                        validateMedicationRequest(medicationRequest, FHIRMedicationRequest);
                                        {
                                                    ...
                                                    if (!session.user) {
                                                        ...
                                                        if (!session.user) {
                                                            ...
                                                            if (!session.user) {
                                                                 ...
                                                                 */ ;
                                                                fromHMSPrescription(hmsPrescription, unknown);
                                                                FHIRMedicationRequest;
                                                                {
                                                                    const ;
                                                                    "MedicationRequest",
                                                                    ...
                                                                    "Practitioner",
                                                                        authoredOn;
                                                                    hmsPrescription.prescribedDate || hmsPrescription.createdAt;
                                                                            ...
                                                                            if (!session.user) {
                                                                                ...
                                                                                if (!session.user) {
                                                                                    ...
                                                                                    if (!session.user) {
                                                                                        ...
                                                                                        unknown;
                                                                                        { // FHIRAllergyIntolerance would be defined in a separate file;
                                                                                            return { resourceType: "AllergyIntolerance", } `Patient/${data.patientId}`,
                                                                                                type;
                                                                                            "Patient";
                                                                                        }
                                                                                        [{ system: "https://www.nlm.nih.gov/research/umls/rxnorm",
