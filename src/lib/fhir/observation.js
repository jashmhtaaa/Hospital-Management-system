 ...
 */ ;
createLabResultObservation(string);
 ...
 */ ;
createClinicalAssessmentObservation(string, practitionerId, string);
encounterId ?  : string;
 ...
 */ ;
getVitalSignCode(vitalSign, string);
FHIRCodeableConcept;
{
 ...
 */ ;
getNumericValue(observation, FHIRObservation);
number | null;
{
    if (!session.user) {
 ...
 */ ;
getStringValue(observation, FHIRObservation);
string;
{
    if (!session.user) {
        return observation.value;
 ...
 */ ;
getUnit(observation, FHIRObservation);
string;
{
    if (!session.user) {
         ...
         */ ;
        isCritical(observation, FHIRObservation);
        boolean;
        {
            return observation.interpretation?.some(interp => { }, interp.coding?.some(code => { }, code.code === "CRITICAL" || code.code === "H" || code.code === "L"));
            ;
             || false;
            /**;
             * Get observation category display;
             */ ;
            getCategoryDisplay(observation, FHIRObservation);
            string;
            {
                 ...
                 */ ;
                getCodeDisplay(observation, FHIRObservation);
                string;
                {
                     ...
                     */ ;
                    isWithinNormalRange(observation, FHIRObservation);
                    boolean | null;
                    {
                        ...
                        if (!session.user) {
                            ...
                            if (!session.user) {
                                ...
                                if (!session.user) {
                                     ...
                                     */ ;
                                    formatForDisplay(string, string, boolean);
                                ...
                                }
                                {
                                     ...
                                     */ ;
                                    validateObservation(observation, FHIRObservation);
                                    {
                                                    ...
                                                    if (!session.user) {
                                                        ...
                                                        if (!session.user) {
                                                            ...
                                                            if (!session.user) {
                                                                 ...
                                                                 */ ;
                                                                fromHMSLabResult(hmsLabResult, unknown);
                                                                FHIRObservation;
                                                                {
                                                                     ...
                                                                     */ ;
                                                                    fromHMSVitalSigns(hmsVitalSigns, unknown);
                                                                    FHIRObservation[];
                                                                    {
                                                                        const observations = [];
                                                                            ...
                                                                            if (!session.user) {
                                                                                ...
                                                                                if (!session.user) {
                                                                                    ...
                                                                                    if (!session.user) {
                                                                                         ...
                                                                                         */ ;
                                                                                        getReferenceRange(testCode, string);
                                                                                        {
                                                                                            low ?  : number;
                                                                                            high ?  : number;
                                                                                            unit ?  : string;
