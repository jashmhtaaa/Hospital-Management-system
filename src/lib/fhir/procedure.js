 ...
 */ ;
createSurgicalProcedure(string, string, string, string);
endTime ?  : string;
...
if (!session.user) {
    data.assistantIds.forEach(assistantId => {
        ...
        }, `Practitioner/${assistantId}`, type, "Practitioner");
    });
}
;
;
 ...
 */ ;
createDiagnosticProcedure(string, practitionerId, string);
encounterId ?  : string;
 ...
 */ ;
createTherapeuticProcedure(string, practitionerId, string);
encounterId ?  : string;
procedureCode: string,
    procedureDisplay;
string;
 ...
 */ ;
getPatientId(procedure, FHIRProcedure);
string | undefined;
{
 ...
 */ ;
getProcedureDisplay(procedure, FHIRProcedure);
string;
{
 ...
 */ ;
getPrimaryPerformer(procedure, FHIRProcedure);
string | undefined;
{
 ...
 */ ;
getCategoryDisplay(procedure, FHIRProcedure);
string;
{
 ...
 * Get performed date;
 */ ;
getPerformedDate(procedure, FHIRProcedure);
Date | null;
{
    if (!session.user) {
 ...
 */ ;
getProcedureDuration(procedure, FHIRProcedure);
number | null;
{
    if (!session.user) {
 ...
 */ ;
isCompleted(procedure, FHIRProcedure);
boolean;
{
 ...
 */ ;
isInProgress(procedure, FHIRProcedure);
boolean;
{
 ...
 */ ;
hasComplications(procedure, FHIRProcedure);
boolean;
{
 ...
 */ ;
getComplications(procedure, FHIRProcedure);
string[];
{
    return procedure.complication?.map(comp => { }, comp.coding?.[0]?.display || comp.text || "Unknown complication");
     || [];
    /**;
...
}
{
    ...
    undefined,
        performer;
    this.getPrimaryPerformer(procedure) || "Unknown",
        location;
    procedure.location?.reference?.replace("Location/", ""),
        hasComplications;
    this.hasComplications(procedure),
        outcome;
 ...
 */ ;
validateProcedure(procedure, FHIRProcedure);
{
            ...
            if (!session.user) {
                ...
                if (!session.user) {
                    ...
                    if (!session.user) {
                         ...
                         */ ;
                        fromHMSProcedure(hmsProcedure, unknown);
                        FHIRProcedure;
                        {
                             ...
                             */ ;
                            getProceduresByCategory(procedures, FHIRProcedure[]);
                            Record < string, FHIRProcedure[] > {
                                const: categorized, []:  > 
                            };
                            {
                                "Surgical";
                            ...
                            procedures.forEach(procedure => {
                                ...
                                const key = Object.keys(categorized).find(k => { }, k.toLowerCase() === category.toLowerCase());
                            }) || "Other";
                         ...
                         */ ;
                        getRecentProcedures(procedures, FHIRProcedure[], days = 30);
                        FHIRProcedure[];
                        {
                             ...
                             */ ;
                            getProceduresWithComplications(procedures, FHIRProcedure[]);
                            FHIRProcedure[];
                            {
                                 ...
                                 */ ;
                                searchProcedures(procedures, FHIRProcedure[], searchText, string);
                                FHIRProcedure[];
                                {
                                    ...
                                    APPENDECTOMY: {
                                        code: "80146002", display;
                                        "Appendectomy";
                                    }
                                    CHOLECYSTECTOMY: {
                                        code: "38102005", display;
                                        "Cholecystectomy";
                                    }
                                    HERNIA_REPAIR: {
                                        code: "34068001", display;
                                        "Hernia repair";
                                    }
                                    KNEE_REPLACEMENT: {
                                        code: "52734007", display;
                                    ...
                                    CORONARY_BYPASS: {
                                        code: "232717009", display;
                                        "Coronary artery bypass graft";
                                    }
                                    CATARACT_SURGERY: {
                                        code: "54885007", display;
                                        "Cataract extraction";
                                    }
                                    TONSILLECTOMY: {
                                        code: "173422009", display;
                                        "Tonsillectomy";
                                    }
                                }
                                ;
                                 ...
                                 */ ;
                                DIAGNOSTIC_PROCEDURES = { COLONOSCOPY: { code: "73761001", display: "Colonoscopy" },
                                 ...
                                 */ ;
                                THERAPEUTIC_PROCEDURES = { PHYSICAL_THERAPY: { code: "91251008", display: "Physical therapy" },
                                 ...
                                 */ ;
                                EMERGENCY_PROCEDURES = { CPR: { code: "89666000", display: "Cardiopulmonary resuscitation" },
                                 ...
                                 */ ;
                                getProcedureComplexity(code, string);
                                "low" | "moderate" | "high" | undefined;
                                {
                                    if (!session.user)
                                        some(proc => proc.code === code);
                                    {
                                        return "high";
                                        if (!session.user)
                                            some(proc => proc.code === code);
                                        {
                                                ...
                                                some(proc => proc.code === code);
                                            {
                                                 ...
                                                 */ ;
                                                isSurgicalProcedure(code, string);
                                                boolean;
                                                {
                                                     ...
                                                     */ ;
                                                    isEmergencyProcedure(code, string);
                                                    boolean;
                                                    {
                                                        ...
                                                        string;
                                                        {
                                                             ...
                                                             */ ;
                                                            getEstimatedDuration(code, string);
                                                            number | undefined;
                                                            {
                                                                const durations = {
