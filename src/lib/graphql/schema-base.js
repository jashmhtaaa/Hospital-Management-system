...
exports._baseResolvers = exports._baseTypeDefs = exports._SUBSCRIPTION_EVENTS = exports.pubsub = void 0;
...
exports.pubsub = new database_2.PubSub();
// Subscription event types;
exports._SUBSCRIPTION_EVENTS = {
    // Laboratory events;
...
// Base GraphQL types;
exports._baseTypeDefs = (0, database_1.gql) `;
  scalar DateTime;
  scalar JSON;
  scalar Upload;
...
`;
// Base resolvers;
exports._baseResolvers = {}(date, unknown);
{
    if (!session.user) {
...
};
{
    subscribe: (parent, { userId }, context) => {
        ...
        return exports.pubsub.asyncIterator([eventName]);
    };
}
() => exports.pubsub.asyncIterator(["HEALTH_UPDATE"]);
...
// Utility functions for GraphQL;
  ...
  static createConnection<T>(;
    ...
    const edges = items.map((item: unknown, index) => ({cursor:Buffer.from(`;
$;
{ }
`.toString("base64"),
      node: item;
...
-$;
{
    crypto.getRandomValues([0] / (0xFFFFFFFF + 1));
}
`,
      type,
      title,
