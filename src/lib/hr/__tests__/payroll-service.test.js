...
describe("Payroll Service", () => {
    let prisma;
    (0, module_1.beforeEach)(() => {
        prisma = new module_2.PrismaClient();
    ...
    describe("generatePayrollEntries", () => {
        it("should generate payroll entries for all active employees", async () => {
            ...
            const mockSalaryStructures = [];
            {
                ...
                [];
                {
                    name: "Housing Allowance", type;
                    "ALLOWANCE", amount;
                    1000, calculationType;
                    "FIXED";
                }
                {
                    name: "Transport Allowance", type;
                    "ALLOWANCE", amount;
                    500, calculationType;
                    "FIXED";
                }
            ...
            {
                employeeId: "emp1", date;
                new Date("2025-05-01"), status;
                "PRESENT";
            }
            {
                employeeId: "emp1", date;
                new Date("2025-05-02"), status;
                "PRESENT";
            }
            ;
    ...
    describe("calculatePayroll", () => {
        ...
        expect(result).toEqual({ baseSalary: 3500,
            1000: ,
            []:  }, { name: "Base Salary", type: "BASE", amount: 3500, calculationType: "ATTENDANCE_BASED", originalAmount: 5000 }, { name: "Housing Allowance", type: "ALLOWANCE", amount: 1000, calculationType: "FIXED" }, { name: "Transport Allowance", type: "ALLOWANCE", amount: 500, calculationType: "FIXED" }, { name: "Income Tax", type: "DEDUCTION", amount: 1000, calculationType: "PERCENTAGE", originalAmount: 20 });
    });
});
;
