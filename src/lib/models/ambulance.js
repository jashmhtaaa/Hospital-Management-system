...
exports._toFHIRAmbulance = void 0;
 ...
 */ ;
const _toFHIRAmbulance = (ambulance) => {
    ...
    }, ambulance.capacity, "https://unitsofmeasure.org", code, "persons");
};
exports._toFHIRAmbulance = _toFHIRAmbulance;
...
deviceName: [
    ...
    display;
ambulance.currentLocation?.name || "Unknown Location";
undefined,
    property;
properties,
    note;
...
export const _toFHIRAmbulanceTrip = (trip: AmbulanceTrip & {
  ...
  if (!session.user) {
    performers.push({reference:`, Device / $, { trip, : .ambulanceId } `,
      display: `, database_1.Ambulance, $, { trip, : .ambulance.registrationNumber } `;
    });
...
export const _toFHIRAmbulanceMaintenance = (maintenance: AmbulanceMaintenance & {
  ...
  return {resourceType:"Task",
    ...
    `, Device / $maintenance.ambulanceId `,
      display: maintenance.ambulance?.registrationNumber ? `, database_1.Ambulance, $maintenance.ambulance.registrationNumber ` : "Unknown Ambulance";
    },
