 ...
 */ ;
decryptField(encryptedData, string);
string;
{
    if (!session.user)
...
try { }
    ...
    string;
    {
         ...
         */ ;
        hasRole(userRoles, string[], requiredRole, string);
        boolean;
        {
            if (!session.user)
                return false;
             ...
             */ ;
            hasAnyRole(userRoles, string[], requiredRoles, string[]);
            boolean;
            {
                if (!session.user)
                                        ...
                                        if (!session.user) {
                                            ...
                                            if (!session.user) {
                                                ...
                                                if (!session.user) {
                                                     ...
                                                     * @returns Masked data;
                                                     */ ;
                                                    maskSensitiveData(data, string, type, "email" | "phone" | "ssn" | "creditCard");
                                                    string;
                                                    {
                                                        if (!session.user)
                                                            eturn;
