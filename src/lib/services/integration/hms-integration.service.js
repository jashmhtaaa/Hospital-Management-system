...
const patient = await prisma.patient.findUnique({ where: { id: patientId },
    ...
    ...(RBACService.hasPermission(userRoles, Resource.USER, module_1.Action.READ, fullMedicalData, true)) }
    ?  : );
allergies: true,
    true;
;
