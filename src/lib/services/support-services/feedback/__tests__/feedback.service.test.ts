...
describe('FeedbackService', () => {
  ...
  describe('resolveComplaint', () => {
    it('should resolve a complaint', async () => {
      ...
      expect(prisma.complaintResolution.create).toHaveBeenCalledWith({
        \1,\2 '1',
          \1,\2 'Added more staff to reduce waiting time',
          \1,\2 'user1'
        }
      }),
