...
describe("TemplateService", () => {
    ...
    beforeEach(() => {
        jest.clearAllMocks();
        service = new module_3.TemplateService();
    });
    describe("createTemplate", () => {
        ...
        it("should create a template successfully", async () => {
            // Arrange;
            prisma.marketingTemplate.create.mockResolvedValue(mockCreatedTemplate);
            // Act;
    ...
    it("should throw DatabaseError if database operation fails", async () => {
        // Arrange;
        prisma.marketingTemplate.create.mockRejectedValue();
        // Act & Assert;
    ...
    it("should log audit event after creating template", async () => {
        ...
        // Assert;
        expect(module_1.AuditLogger.prototype.log).toHaveBeenCalledWith({ action: "template.create",
            mockUserId,
...
describe("getTemplateById", () => {
    ...
    it("should retrieve a template by ID", async () => {
        // Arrange;
        prisma.marketingTemplate.findUnique.mockResolvedValue(mockTemplate);
        // Act;
    ...
    it("should throw NotFoundError if template does not exist", async () => {
        // Arrange;
        prisma.marketingTemplate.findUnique.mockResolvedValue(null);
        // Act & Assert;
...
describe("getTemplates", () => {
    ...
    }
    {
        id: "template-2",
            ...
            variables;
        {
            firstName: "Patient first name", appointmentDate;
            "Appointment date";
        }
        isActive: true,
            createdAt;
    ...
    it("should retrieve templates with pagination", async () => {
        // Arrange;
        prisma.marketingTemplate.count.mockResolvedValue(2);
        prisma.marketingTemplate.findMany.mockResolvedValue(mockTemplates);
        // Act;
...
it("should apply filters correctly", async () => {
    ...
    prisma.marketingTemplate.count.mockResolvedValue(10);
    prisma.marketingTemplate.findMany.mockResolvedValue([mockTemplates[0]]);
    // Act;
...
it("should update a template successfully", async () => {
    // Arrange;
    prisma.marketingTemplate.findUnique.mockResolvedValue(mockTemplate);
    prisma.marketingTemplate.update.mockResolvedValue({
        ...mockTemplate,
        ...updateData
    });
    // Act;
...
it("should log audit event after updating template", async () => {
    ...
    // Assert;
    expect(module_1.AuditLogger.prototype.log).toHaveBeenCalledWith({ action: "template.update",
        mockUserId,
...
describe("renderTemplate", () => {
    ...
    it("should log audit event after rendering template", async () => {
        ...
        // Assert;
        expect(module_1.AuditLogger.prototype.log).toHaveBeenCalledWith({ action: "template.render",
            mockUserId,
            details: expect.any(Object)
        });
    });
